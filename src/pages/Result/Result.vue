...
<div class="container-fluid">
  <div class="row">
    <div class="col">
      <div class="titulo"><h1>Github Search</h1>
    </div></div>
    <div class="col">
  ...
  <div class="row">
    <div class="col">
      ...
      <div class="row-8">
        <div class="nomeMaiusculo"><h1 class="display">{{ user.name }}</h1></div>
        <div class="nomeMinusculo"><h2 class="display">{{ username }}</h2></div>
      <div class="todosIcones">
        <div><OrganizationIcon/>
        <div><LocationIcon />
        <div><StarIcon />
        <div><RepositoryIcon />
        <div><FollowersIcon />
...
export default {
  ...
  created: function() {
    ...
    var repositoriesRequest = octokit.repos.listForUser({ username: this.username });
    repositoriesRequest.then((response) => {
